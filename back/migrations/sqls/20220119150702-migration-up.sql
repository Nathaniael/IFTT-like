...
('Area deleted', 'This trigger a reaction when you delete the specified area', '[{"number":"id"}]', '', '7'),
('Area created', 'This trigger a reaction when you create an area', '[]', '', '7'),
('Username change', 'This trigger a reaction when you change your area username', '[]', '', '7');
